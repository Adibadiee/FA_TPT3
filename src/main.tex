...
Um dieses Problem zu lösen könnte man eine strukturierte, Bewertungsrahmen spezifisch für die Systel entwickeln. Außerdem ist es notwendig ein mehrstufiges Verfahren zu folgen in dem. In einem ersten Schritt werden durch Literaturrecherchen sowie Gespräche mit internen Fachbereichen relevante funktionale und nicht-funktionale Kriterien ermittelt, um sie nachher thematisch zu ordnen und gewichten zu können. Diese dienen als Grundlage für einen einheitlichen Kriterienkatalog zur Bewertung von Dashboard-Tools. 

Masßnahmen: Anregung zur Zusammenarbeit zwischen den Teams, so dass der Austausch zwischen den teams 
In der letzten Phase wird der Katalog auf ausgewählte Tools angewendet. Das Ergebnis dieser Arbeit ist eine Bewertungsmatrix, die eine transparente und objektive Entscheidungsgrundlage für zukünftige Projektauswahlen bietet. Sie sollte einen welches Tool für welchen Use-Case am besten geeignet ist.\\
